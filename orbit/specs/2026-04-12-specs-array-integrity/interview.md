...
**Date:** 2026-04-12
**Interviewer:** Agent
**Card:** orbit/cards/0004-specs-array-integrity.yaml
...
**A:** In `/orb:spec` — the interview already names the card (`Card: orbit/cards/NNNN-slug.yaml`), so the spec skill has the information it needs. Keep it in one place rather than adding a hook.
