...
| orbit/decisions/0009-rally-parallel-drive-full.md | new | decision |

Three files changed: `orbit/decisions/0009-rally-parallel-drive-full.md` (+58/-0), `plugins/orb/skills/rally/SKILL.md` (+30/-7 by diff hunks), `orbit/specs/2026-04-19-rally-subagent-model/progress.md` (flips the three deferred rows).
...
**1. Are the four §7c decision citations accurate by title?** Yes. Grep of each `orbit/decisions/000[4-7]-*.md` file's header line produces an exact string match against SKILL.md §7c lines 331–334. No typos, no paraphrasing that would mislead a cold reader.
