...
- Thin cards are a orbit/cards/ hygiene issue — the author can thicken via `/orb:card` or run the card individually via `/orb:drive`. Neither is a rally problem.
...
- orbit/specs/2026-04-19-rally-subagent-model/spec.yaml — constraint #3, ac-01
- orbit/specs/2026-04-19-rally-subagent-model/interview.md — Q3 (2026-04-19 discovery)
