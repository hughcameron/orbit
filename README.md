...
This creates the directory structure (`.orbit/cards/`, `.orbit/specs/`, `.orbit/choices/`), adds a workflow snippet to your `CLAUDE.md`, and walks you through writing your first feature card.
