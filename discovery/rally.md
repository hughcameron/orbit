...
Options:
- **A. Include output instructions in the agent brief.** The lead agent tells each design agent exactly where to save: `specs/YYYY-MM-DD-<slug>/interview.md`. Simple, relies on the lead getting it right.
...
cards:
  - path: cards/0015-execution-resilience.yaml
    status: designing
    spec_dir: specs/2026-04-19-execution-resilience/
  - path: cards/0016-pipeline-parameterisation.yaml
    status: designing
    spec_dir: specs/2026-04-19-pipeline-parameterisation/
  - path: cards/0017-lifecycle-hooks.yaml
    status: designing
    spec_dir: specs/2026-04-19-lifecycle-hooks/
