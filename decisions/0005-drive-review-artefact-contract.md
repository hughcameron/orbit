...
- Constraint #3 in `specs/2026-04-20-drive-forked-reviews/spec.yaml`: "File-on-disk is the only authoritative source for the verdict. Drive does not consult the forked agent's chat response under any circumstance."
