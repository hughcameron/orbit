...
- All prior review files (`specs/*/review-*.md`) already produce the canonical line; the contract is made explicit rather than introduced
- Reviewed by the progressive spec-review on `specs/2026-04-20-drive-forked-reviews/spec.yaml` — Pass 1 and Pass 2 both clean on this decision
