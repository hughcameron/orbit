...
- .orbit/choices/0008-rally-subagent-path-discipline.md — trust + post-verify with three primitives (first PR)
- .orbit/choices/0010-rally-thin-card-guard.md — refuse at proposal, unconditional (first PR)
- .orbit/choices/0009-rally-parallel-drive-full.md — delegate to drive-full; nested forked Agents are transitive (follow-up PR; cites 0004–0007)
...
- .orbit/choices/0009-rally-parallel-drive-full.md (new)
...
- .orbit/specs/2026-04-19-rally-subagent-model/progress.md (this file)
- .orbit/choices/0008-rally-subagent-path-discipline.md (new)
- .orbit/choices/0010-rally-thin-card-guard.md (new)
