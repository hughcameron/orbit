...
**Pass:** 2
**Description:** review-spec/SKILL.md line 123 says *"Save the review to: `specs/YYYY-MM-DD-<topic>/review-spec-<date>.md`"*. The forked agent, reading the SKILL.md cold, will follow this default path. Drive's cycle-ordinal scheme (ac-19) requires forks on cycles 2 and 3 to write to `-v2.md` / `-v3.md`. This override must come from drive's brief, but:
