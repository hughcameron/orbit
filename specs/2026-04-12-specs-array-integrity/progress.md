...
**Spec:** specs/2026-04-12-specs-array-integrity/spec.yaml
**Started:** 2026-04-12
...
|-------|--------------|---------|
| `/orb:design` | `specs/` | Orphaned specs not in card's specs array |
| `/orb:distill` | `cards/` | Overlap with existing capabilities |
| `/orb:card` | `cards/`, `specs/` | Overlap check before creating |
| `/orb:discovery` | `specs/`, `decisions/` | Prior art on the topic |
| `/orb:implement` | Project source | Existing code/patterns to build on |
| `/orb:review-pr` | `decisions/` | Decisions the PR should respect |
